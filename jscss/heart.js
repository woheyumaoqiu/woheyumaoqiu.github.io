(function ($) {
			...
			function drawRect_URow(){
				garden.createRandomBloom(URowX, URowY, 5);
				URowX = URowX + 25;
			}
			
			function drawRect_DRow(){
				garden.createRandomBloom(DRowX, DRowY + 185, 5);
				DRowX = DRowX + 25;
			}
			
			function drawRect_LRoll(){
				garden.createRandomBloom(LRollX, LRollY, 5);
				LRollY = LRollY + 25;
			}
			
			function drawRect_RRoll(){
				garden.createRandomBloom(RRollX + 500, RRollY, 5);
				RRollY = RRollY + 25;
			}
			...
			function drawHeart(){
				...
				if(flag < 31){
					if(flag%8==0){
						garden.createRandomBloom(heartX, heartY, 5);
					}
				}else if(flag % 4 == 0){
			...
			function getX(t) {//由弧度得到 X 坐标
				return 305+r*(16*Math.sin(t));
			}
			 
			function getY(t) {//由弧度得到 Y 坐标
				return 295-r*(16*Math.cos(t));
			}
			//---------------------------------------------------------------
		    });
		})(jQuery);